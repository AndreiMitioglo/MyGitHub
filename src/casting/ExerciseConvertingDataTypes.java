 ...
 */
        ...
        String num1 = "23"; // cannot put letters, cannot convert worlds to int.
        String num2 = "25";
 ...
 */
        ...
        String save = "390";  // money always to double
        String day = "15.60";

        double saveDouble = Double.parseDouble(save);
        double dayDouble = Double.parseDouble(day); // String to Primitive


        System.out.println((int) (saveDouble / dayDouble)); // int -> ca sa dee numere intregi "zile"(25);
