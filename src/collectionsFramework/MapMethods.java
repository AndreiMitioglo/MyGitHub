...
public class MapMethods {
    public static void main(String[] args) {
        ...
        // Keys: Day, City, Car, Pet
        // Values: Friday, Black, Chicago, Lexus, Turtle

       Set<String> keys =  favorites.keySet(); // values stored in Set list
        System.out.println(keys);// [Car, Color, City, Day, Pet]

        Collection<String> values = favorites.values(); // values stored in Collection list
